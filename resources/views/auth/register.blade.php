...
<div class="w-full min-h-screen flex flex-col md:flex-row items-center justify-center bg-[#f0f0f0] p-4 md:p-8">
    ...
    <div class="w-full max-w-[1100px] flex flex-col md:flex-row bg-white overflow-hidden md:rounded-[40px] md:shadow-2xl min-h-[500px] md:min-h-[600px] border border-black/5">
        ...
        <div class="w-full md:w-[600px] p-8 md:p-12 lg:p-16 flex flex-col justify-center bg-white">
            <!-- Navigation -->
            <div class="w-full mb-6">
                <a href="/login" class="flex items-center space-x-2 text-[#072ac6] text-[13px] font-bold transition-colors hover:underline">
            ...
            <!-- Title -->
            <h1 class="text-[31px] font-black text-[#072ac6] mb-1 leading-tight tracking-tight">
                Join us, <span class="text-[#f5c32f]">KlasMate!</span>
            </h1>
            <p class="text-[#072ac6] text-[12px] mb-8 font-bold uppercase tracking-wider">Create your account</p>

            @if($errors->any())
                <div class="mb-6 p-4 bg-red-50 border-l-4 border-red-500 text-red-700 text-[12px] rounded-r-xl">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" placeholder="Display Name" required 
                            class="w-full pl-12 pr-4 py-3 border @error('name') border-red-500 @else border-[#072ac6]/10 @enderror rounded-full focus:outline-none text-[12px] text-[#072ac6] placeholder-[#072ac6]/40 bg-gray-50">
                        @error('name')
                    ...
                    <div class="relative">
                        ...
                        <input type="email" name="email" value="{{ old('email') }}" placeholder="Email" required 
                            class="w-full pl-12 pr-4 py-3 border @error('email') border-red-500 @else border-[#072ac6]/10 @enderror rounded-full focus:outline-none text-[12px] text-[#072ac6] placeholder-[#072ac6]/40 bg-gray-50">
                        @error('email')
                            <p class="text-red-500 text-[10px] mt-1 ml-4 font-bold">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="school" value="{{ old('school') }}" placeholder="School (Optional)" 
                            class="w-full pl-12 pr-4 py-3 border @error('school') border-red-500 @else border-[#072ac6]/10 @enderror rounded-full focus:outline-none text-[12px] text-[#072ac6] placeholder-[#072ac6]/40 bg-gray-50">
                        @error('school')
                            <p class="text-red-500 text-[10px] mt-1 ml-4 font-bold">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="program" value="{{ old('program') }}" placeholder="Program (Optional)" 
                            class="w-full pl-12 pr-4 py-3 border @error('program') border-red-500 @else border-[#072ac6]/10 @enderror rounded-full focus:outline-none text-[12px] text-[#072ac6] placeholder-[#072ac6]/40 bg-gray-50">
                        @error('program')
                            <p class="text-red-500 text-[10px] mt-1 ml-4 font-bold">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="relative">
                        ...
                        <input type="password" name="password" id="password" placeholder="Password" required 
                            class="w-full pl-12 pr-12 py-3 border @error('password') border-red-500 @else border-[#072ac6]/10 @enderror rounded-full focus:outline-none text-[12px] text-[#072ac6] placeholder-[#072ac6]/40 bg-gray-50">
