                        ...
                        <div class="flex items-center justify-between p-4 border border-black rounded-[15px] bg-white shadow-sm">
                            ...
                            <div>
                                ...
                                <template x-if="user.friend_status === 'accepted'">
                                    <button @click="window.location.href='/chat/' + user.id" class="p-2 text-[#072ac6] hover:bg-gray-100 rounded-full transition-colors">
                ...
                <div class="space-y-3">
                    @forelse($friends as $friend)
                        <div class="flex items-center justify-between p-4 border border-black rounded-[15px] bg-white shadow-sm active:scale-[0.98] transition-transform">
                            ...
                            <button @click="window.location.href='/chat/{{ $friend->id }}'" class="p-2 text-[#072ac6] hover:bg-gray-100 rounded-full transition-colors">
                                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path d="M8 10h.01M12 10h.01M16 10h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" stroke-linecap="round" stroke-linejoin="round"/></svg>
                            </button>
                        </div>
                    @empty
