            ...
            <form action="/login" method="POST" class="w-full space-y-4 max-w-sm">
                ...
                <div class="relative">
                    ...
                    <input type="email" name="email" placeholder="Email" required 
                        class="w-full pl-12 pr-4 py-3 border border-[#072ac6] rounded-full focus:outline-none focus:ring-2 focus:ring-[#072ac6]/20 transition-all text-[#072ac6] placeholder-[#072ac6]/50 text-[14px]">
                </div>
                ...
                <div class="relative">
                    ...
                    <input type="password" name="password" id="password" placeholder="Password" required 
                        class="w-full pl-12 pr-12 py-3 border border-[#072ac6] rounded-full focus:outline-none focus:ring-2 focus:ring-[#072ac6]/20 transition-all text-[#072ac6] placeholder-[#072ac6]/50 text-[14px]">
